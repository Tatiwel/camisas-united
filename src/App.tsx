  ...
  return (
    <div className="bg-gray-900 h-screen w-screen font-semibold text-lg">
      ...
      <div className="pt-6 bg-white flex items-center">
        ...
        <a
          href=""
          className="pl-12 text-xl font-semibold flex items-center transition-transform transform hover:scale-110"
        >
          <h1>
      ...
      <div className="pt-6 flex items-center bg-gradient-to-r from-black to-gold  max-w-width100vw">
        ...
        <a
          href=""
          className=" text-white ml-12 text-xl font-semibold flex items-center transition-transform transform hover:scale-110"
        >
          <h1>
